...
sheet_file = 'H:\Work\git_repository\radiomics_captk_pipeline\Example\example_im_mask_location.xlsx';
sheet_num = 1;%5; % which sheet in the Excel file?
sheet_range = 'A2:C2'%'A2:C76'; % what range of cells to load?
listdir = 'H:\Work\git_repository\radiomics_captk_pipeline\Example\lists_after_a';%where to save the lists
outdir = 'H:\Work\git_repository\radiomics_captk_pipeline\Example\lists_after_a'; % where to save outputs
