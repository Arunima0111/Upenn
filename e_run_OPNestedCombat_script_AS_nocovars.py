...
#sys.path.append('Z:\home\slavkovk\Code\opnested-combat-main\Functions')
#sys.path.append('/Users/Kalina/Documents/CBIG/Code/opnested-combat-main/Functions')
sys.path.append('H:/Work/git_repository/radiomics_captk_pipeline/utils')
...
codepath = "H:/Work/git_repository/radiomics_captk_pipeline/utils/"
clinical_path = "H:/Work/git_repository/radiomics_captk_pipeline/Testing/"
resultpath = "H:/Work/git_repository/radiomics_captk_pipeline/Testing/Results/"
...
#datfile = "DCIS_R01_consolidated_features.xlsx"
datfile = "feature_label_example_features_processed.xlsx"
...
covfile = "first_postcontrast_features_allData_n297_vivian_AS.xlsx"
...
resultsfolder = "Results_after_harm_12dec2023"
...
data_df.to_csv(resultpath+"Results"+"data_df_check_vb.csv")
...
batch_df.to_csv(resultpath+"Results"+"batch_df_after_categorizing_check.csv")
...
covars = pd.concat([batch_df], axis=1)
...
gmm_df = nested.GMMSplit(dat, caseno, resultpath)
