...
resultsfolder = "Results_after_harm"
...
data_df.to_csv(datapath+"Results"+"data_df_check_vb.csv")
...
batch_df.to_csv(datapath+"Results"+"batch_df_after_categorizing_check.csv")
