...
sheet_file = 'H:\Work\git_repository\radiomics_captk_pipeline\Testing\DCIS_R01_im_mask_location.xlsx';
sheet_num = 1;%5; % which sheet in the Excel file?
sheet_range = 'A2:C299'%'A2:C76'; % what range of cells to load?
listdir = 'H:\Work\git_repository\radiomics_captk_pipeline\Testing\lists';%where to save the lists
outdir = 'H:\Work\git_repository\radiomics_captk_pipeline\Testing\features'; % where to save outputs
listlab = 'DCIS_R01'; % suffix to be used in the list names when saving
outlab = 'DCIS_R01_v2'; % label to attach to output file names when saving
