...
cases = importdata(fullfile(listdir, 'id_DCIS_R01.list'));
outputs = importdata(fullfile(listdir,'output_DCIS_R01.list'));
save_lab = 'DCIS_R01'; %label to use when saving the consolidated spreadsheet
save_dir = 'H:\Work\git_repository\radiomics_captk_pipeline\Testing\features';
